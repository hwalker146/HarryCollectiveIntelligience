#!/usr/bin/env python3
"""
Run analysis on the specific new episodes we detected
"""
import os
import sqlite3
import openai
...
def analyze_new_episodes():
    """Analyze the new episodes using existing prompts"""
...
- Focus on actionable market intelligence"""
    ...
    print(f"🧠 Found {len(episodes_to_analyze)} new episodes for analysis")
